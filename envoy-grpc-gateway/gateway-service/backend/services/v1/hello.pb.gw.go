...
/*
Package backend_services_v1 is a reverse proxy.
...
var (
	pattern_HelloService_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "hello"}, "", runtime.AssumeColonVerbOpt(true)))
)
